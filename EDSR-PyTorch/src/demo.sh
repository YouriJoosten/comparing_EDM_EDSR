...
#python.exe main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2
...
#python.exe main.py --dir_data [C:\Users\youri\OneDrive\BachelorThesis\EDSR-PyTorch\test]  --model EDSR --scale 3 --patch_size 144 --save edsr_baseline_x3 --reset --pre_train #[C:\Users\youri\OneDrive\BachelorThesis\EDSR-PyTorch\experiment\model\EDSR_x2.pt]
...
python.exe main.py --data_test Demo --scale 4 --pre_train download --test_only --save_results #
